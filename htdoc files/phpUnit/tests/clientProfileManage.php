<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        $profileManage = $user-> profileManage($_REQUEST['email'],$_REQUEST['password']);
        if($profileManage){
...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="styles/clientProfileManage.css">
    ...
    <body>
        ...
        <div class="centerBox">
            ...
            <div class="formGroup">
                <form action="processes/profileManage.php" method="POST">
                    <label for="fullName">*Full name :</label>
                    <input type="text" id="fullName" name="fullName" maxlength="50" required="required"><br>
                    <br>
                    <label for="address1">*Address 1 :</label>
                    <input type="text" id="address1" name="address1" maxlength="100" required="required"><br>
                    <br>
                    <label for="address2">Address 2 :</label>
                    <input type="text" id="address2" name="address2" maxlength="100" onfocus="this.value=''" placeholder="apartment, suite or space #"><br>
                    <br>
